...
export class App extends Vue {
  ...
  private hostInternally = getQueryString('host') || 'localhost'
  private portInternally = +getQueryString('port')! || 9999
  private mainPackInternally = getQueryString('main') || ''
  private subPackInternally = getQueryString('sub') || ''
  ...
  set mainPack(value: string) {
    // localStorage.setItem('host', value)
    this.mainPackInternally = value
  }
  get subPack() {
    return this.subPackInternally
  }
  set subPack(value: string) {
    // localStorage.setItem('sub', value)
    this.subPackInternally = value
  }
  get protocol() {
